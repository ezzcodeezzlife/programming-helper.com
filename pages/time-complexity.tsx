...
export default function translate() {
  ...
  if (!session) {
    return (
      <Layout>
        <Head>
          <title>ime complexity from any function any language</title>
          <meta
            name="description"
        ...
        <h1>ime complexity from any function any language:</h1>
        ...
        <p>
          ...
          <button onClick={buttonPressLogin}>Generate Time Complexity</button>
